...
Gem::Specification.new do |s|
  ...
  s.add_dependency "chef", '= 12.0.0' # ~> changed from 11.18.12
  s.add_dependency "ohai", '= 8.0.1' # ~> changed from 7.4.1
  s.add_dependency "mime-types", '= 1.25.1'
  s.add_dependency "mixlib-shellout", '= 2.2.7' # ~> changed from 1.4.0
  s.add_dependency "net-ssh", '= 2.6.5'
  s.add_dependency "net-scp", '= 1.1.2'
  s.add_dependency "net-ldap", '= 0.6.1'
  s.add_dependency "json", '= 1.8.3'
  s.add_dependency "nokogiri", '= 1.6.8' # ~> changed from 1.5.11
  s.add_dependency "kramdown", '= 1.9.0'
  s.add_dependency "route53", '= 0.3.2'
  s.add_dependency "fog-azure-rm", '= 0.2.6'
